...
[_RALT_OVERLAY] = LAYOUT_planck_grid(
    _______, _______, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    RALT_SH, _______, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______
),

[_RALT_SHIFT] = LAYOUT_planck_grid(
    _______, _______, ________, _______, _______, _______, _______, _______, S(KC_7), S(KC_8), S(KC_9), _______,
    _______, _______, ________, _______, _______, _______, _______, _______, S(KC_4), S(KC_5), S(KC_6), _______,
    _______, _______, ________, _______, _______, _______, _______, _______, S(KC_1), S(KC_2), S(KC_3), _______,
    _______, _______, ________, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
