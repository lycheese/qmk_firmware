 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Left | Right| Ctrl | Alt  |    Space    | AltGr| Super| Down |  Up  | Enter|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,
    KC_CAPS, KC_A,    KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, TD(TD_QUOT_BKSL),
    KC_LSFT, KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_ESC,  KC_LEFT, KC_RIGHT, KC_LCTL, KC_LALT, KC_SPC,  KC_SPC,  KC_RALT, KC_LGUI, KC_DOWN, KC_UP,   KC_ENT
),
